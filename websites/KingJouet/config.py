...
SELECTORS = {
    ...
    # Panier
    "cart_items": "#header-cart-infos",
    # On ne peut modifier et voir la quantité que dans le panier
    "quantity_input": ".px-2",
    # C'est la même classe pour le bouton ajouter ou retirer une quantité d'un item
    "add_remove_item": "btn btn-circle p-4 bg-neutral-200 border-none font-semibold btn-process",
    "cart_total": ".attribut-value.text-right.block.font-bold.text-lg.md:text-xl",
    "proceed_to_checkout": "#btn_confirmation",
    # Impossible de vider le panier en un clic
    "empty_cart": ".cart-empty",
    
    # Connexion
    "account-button": ".account-wrapper",
